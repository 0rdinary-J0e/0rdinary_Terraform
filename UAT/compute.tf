...
#   s3_bucket = "ordinaryjoe-app2"           # Correct bucket name
...
#         ],
#         Resource = [
#           "arn:aws:s3:::ordinaryjoe-app2",                    # Allow access to the bucket
#           "arn:aws:s3:::ordinaryjoe-app2/lambda.zip"          # Allow access to the specific object
#         ]
#       }
#     ]
#   })
