...
resource "aws_iam_role" "ordinaryjoe_app_ec2_role" {
  name = "ordinaryjoe_app_ec2_role"
...
resource "aws_iam_role_policy_attachment" "ordinaryjoe_app_attach_secrets_policy" {
  role       = aws_iam_role.ordinaryjoe_app_ec2_role.name
  policy_arn = aws_iam_policy.ordinaryjoe_app_secrets_manager_policy.arn
}
...
#resource "aws_secretsmanager_secret_version" "ordinaryjoe_app_db_credentials_version" {
#  secret_id     = aws_secretsmanager_secret.ordinaryjoe_app_db_credentials.id
