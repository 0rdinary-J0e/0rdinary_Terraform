# Define the VPC
resource "aws_vpc" "ordinaryjoe-prod_app" {
  cidr_block = "10.0.0.0/16"
  tags = {
    Name = "ordinaryjoe-prod-app-vpc"
  }
}
...
resource "aws_internet_gateway" "ordinaryjoe-prod_app_igw" {
  vpc_id = aws_vpc.ordinaryjoe-prod_app.id
  tags = {
    Name = "ordinaryjoe-prod-app-igw"
  }
}
...
resource "aws_route_table" "public_rt" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.ordinaryjoe-prod_app_igw.id
  }
  tags = {
    Name = "ordinaryjoe-prod-app-public-rt"
  }
}
...
resource "aws_security_group" "lambda_sg" {
  ...
  tags = {
    Name = "ordinaryjoe-prod-lambda-sg"
  }
}
