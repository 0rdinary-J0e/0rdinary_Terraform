...
resource "aws_lambda_function" "ordinaryjoe-prod_app_lambda" {
  function_name = "ordinaryjoe-prod-app-lambda"
  ...
  s3_bucket = "ordinaryjoe-prod-app2"           # Correct bucket name
...
resource "aws_iam_role" "lambda_execution_role" {
  name = "ordinaryjoe-prod-app-lambda-role"
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:s3:::ordinaryjoe-prod-app2",                    # Allow access to the bucket
          "arn:aws:s3:::ordinaryjoe-prod-app2/lambda.zip"          # Allow access to the specific object
        ]
      }
    ]
  })
